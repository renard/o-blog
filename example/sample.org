...
- [[file:{lisp}(ob:path-to-root){/lisp}/index.html][/icon-home icon-white/ Home]]
...
- Appearance
  ...
  - [[https://github.com/ericmmartin/simplemodal][JQuery Simplemodal]] support
  - HTML5 / CSS3 ready
- Blog
  - Static pages
...
#+begin_o_blog_admonition info Information
...
** DONE Admonitions						      :usage:
   CLOSED: [2012-01-15 Sun 20:40]

Admonitions are declared in =o_blog_admonition= blocks. There are 4 types of
them:
...
#+begin_o_blog_admonition error Danger
...
#+begin_o_blog_admonition warning Caution
...
#+begin_o_blog_admonition success Tip
