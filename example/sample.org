...
[[file:{lisp}(ob:path-to-root){/lisp}/who-uses.html][/icon-comments-alt/ Who uses]]
...
#+HTML: <h1>What they say</h1>

#+begin_quote
o-blog, great static site generator from emacs org-mode.

-- Pierre-Yves Ritschard [[https://twitter.com/pyr/status/160466727195521024][@pyr]]

-- Sergey Konoplev [[http://twitter.com/gray_hemp][@gray\_hemp]]

-- Olivier Berger [[http://twitter.com/olberger][@olberger]]

-- Dimitri Fontaine [[http://twitter.com/tapoueh][@tapoueh]]

-- Julien Danjou [[http://twitter.com/juldanjou][@juldanjou]]

-- Daniel Farina [[http://twitter.com/danfarina][@danfarina]]
#+end_quote
...
-- [[https://github.com/djcb][Dirk-Jan C. Binnema]]
#+end_quote
...
- [[enard.github.com/o-blog][O-blog Project]]
