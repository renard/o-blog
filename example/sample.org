...
这是一个演示如何使用 [[https://github.com/renard/o-blog][o-blog]] 的站点。
...
详情参见 [[file:blog/index.html][blog]].

** 待办事项
这儿列举了一些中文处理中的问题。具体的解决参见 [[github:exaos/o-blog]].

1. [X] 中文文件名无法正常生成 --> 使用 MD5 取代 sanitize-string
2. [ ] 博客设置中的 =Copyright=, =About= 及 =Navigation= 等 =SNIPPET= 不能用中文
   的问题。
...
- [[#][/icon-book icon-white/ 文档]]
  ...
  - [[file:{lisp}(ob:path-to-root){/lisp}/structures.html][结构]]
...
Here is an example of the =README.asciidoc= file:

#+o_blog_source ../README.asciidoc
